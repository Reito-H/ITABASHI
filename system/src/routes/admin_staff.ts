...
<div style="font-family:'Hiragino Sans','Meiryo',sans-serif;">
  ...
  <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:10px;">
    ...
    <div style="display:flex;gap:8px;">
      <a href="${ADMIN_PATH}/settings/documents?tab=staff-csv" style="padding:8px 14px;background:#f0fdf4;color:#166534;border:1px solid #bbf7d0;border-radius:7px;font-size:13px;font-weight:600;text-decoration:none;">
        CSVインポートはデータセンターへ
      </a>
