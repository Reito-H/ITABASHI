...
import adminSeasonalRoutes, { seasonalPublicApi } from './routes/admin_seasonal';
import adminCmPopupRoutes, { cmPopupPublicApi } from './routes/admin_cm_popup';
...
app.route(`/${SECRET}/admin`, adminSeasonalRoutes);
app.route(`/${SECRET}/admin`, adminCmPopupRoutes);
...
app.route('/api/seasonal', seasonalPublicApi);
app.route('/api/cm-popup', cmPopupPublicApi);
